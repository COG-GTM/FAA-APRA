...
public class IFREnrouteCharts extends BaseService {
	...
	public Response getIFREnrouteRelease(
			...
			@ApiParam(name = "geoname", value = "Geographic region for requested chart", required = true) @QueryParam("geoname") String geo,
			@ApiParam(name = "seriesType", value = "The series type", required = true) @QueryParam("seriesType") String seriesType) {
