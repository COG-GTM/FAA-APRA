...
public class WallPlanningCharts extends BaseService {
	...
	public Response getProductRelease(
			...
			@ApiParam (name="format", description="Format of the requested chart. TIFF format contains georeferenced charts contained within a zip archive and PDF is non-georeferenced charts. If omitted, the default PDF format is returned.") @QueryParam("format") String fmt) {
	...
	public Response getProductEdition(
			...
			@ApiParam (name="format", description="Format of the requested chart. TIFF format contains georeferenced charts in a zip archive file and PDF is non-georeferenced charts. If omitted, the default PDF format is used.")  @QueryParam("format") String fmt) {
