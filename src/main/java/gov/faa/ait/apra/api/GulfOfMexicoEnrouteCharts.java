 ...
 */
@Path("/enroute/gom")
@Tag(name="Gulf of Mexico IFR Enroute Chart")
public class GulfOfMexicoEnrouteCharts extends BaseService {
    ...
    @Path("/chart")
    @Operation(summary="Get Gulf of Mexico IFR enroute chart edition date, edition number, and product download URL", 
    ...
    public Response getGOMRelease (
    		...
    		@Parameter(name="geoname", description="Requested Gulf of Mexico geographic area. If omitted, both west and central links are returned.", required=false) @QueryParam("geoname") String geo) {	
	...
	*/
    ...
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON, MediaType.TEXT_XML})
    @Path("/info")
    @Operation(summary="Get Gulf of Mexico IFR enroute chart edition date and edition number", 
    ...
    public Response getGOMEdition (
    		@Parameter(name="edition", description="Requested product edition. If omitted, current edition is returned.", required=false) @QueryParam("edition") String ed,
    		@Parameter(name="geoname", description="Requested Gulf of Mexico geographic area. If omitted, both west and central are returned.", required=false) @QueryParam("geoname") String geo) {
