...
public class URLCache {
	...
	private boolean isUpdateRequired () {
		...
		ZonedDateTime cycleDateTime = cdu.getCurrentCycle().toInstant().atZone(ZoneId.systemDefault());
		ZonedDateTime lastRefreshDateTime = URLCache.lastFlush.toInstant().atZone(ZoneId.systemDefault());
		
		if (cycleDateTime.isAfter(lastRefreshDateTime)) {
